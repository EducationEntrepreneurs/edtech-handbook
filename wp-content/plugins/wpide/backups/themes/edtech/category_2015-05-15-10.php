<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b5b36394a2b09f8ef6155ad17086bee73c7d2607b7"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-05-15-10.php") )  ) ){
...
?>
    ...
    <div class="wrapper_left">
        <div class="cat_sort">
            <span>Sort by</span>
            <?php if($paged !=""){ ?>
                <select onchange="edtech_url(); session_select();">
