<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b5b36394a2b09f8ef6155ad17086bee7bbe263e7e9"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-04-21-12.php") )  ) ){
                ...
                <div class="cat_posts">
                    ...
                    <div class="author_info">
                        <?php echo get_avatar( get_the_author_meta( 'ID' ), 32 ); 
                              echo get_the_author(); 
                              echo intval(get_post_meta(get_the_ID(), 'vote_count_no',true));
                        ?> 
                    </div>
                    <div class="post_data">
                        <div class="post_image">
