<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19e88604f605"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-05-14-09.php") )  ) ){
...
function all_posts($postid_array,$posttype){
            ...
            $post_matter = $post_matter.'<div class="cat_posts">
                                            ...
                                            <div class="post_data">
                                                ...
                                                <div class="post_content">
                                                    <a href="'.get_post_permalink().'">'.get_the_excerpt().'</a>
                                                </div>
                                            </div>
                                        </div>';
            endwhile;
...
function cat_sort_featured($catname){
    ...
    endwhile;
    wp_reset_query();
    $posts=all_posts($variable_post_ID,$post_featured);
    return $posts;
}
