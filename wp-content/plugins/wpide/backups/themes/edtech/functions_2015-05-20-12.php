<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b5b36394a2b09f8ef6155ad17086bee7cf0e53e2ef"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-05-20-12.php") )  ) ){
...
function vote_counts()
{
    ...
    $meta_values = get_post_meta($post->ID, 'vote_counts_yes', true);
    if(empty($meta_values)){
        //add_post_meta($post->ID, 'vote_counts_yes', '0');
        add_meta_box( 'vote_counts_yes', 'Vote Count Yes', 'post', 'normal', 'high' ,'0' );
    }
    add_post_meta($post->ID, 'vote_counts_yes', '0');
