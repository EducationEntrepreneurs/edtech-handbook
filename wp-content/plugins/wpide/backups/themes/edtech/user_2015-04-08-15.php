<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "97555ad40172e2ae2acf6e24b6801088501bec4cb3"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/user.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/user_2015-04-08-15.php") )  ) ){
        ...
        <div class="wrapper_left">
            ...
            <div class="user_resources">
                <?php   $category =array(6, 7);
                        ...
                        query_posts(array('author'=>$user_id,'cat'=>array(6, 7),'posts_per_page' => 3));
                        ...
                        <p> <?php if(is_category('Explore')){ ?><i class="fa fa-lightbulb-o"></i><?php } ?>
                            <?php if(is_category('Validate')){ ?><i class="fa fa-comment"></i><?php } ?>
