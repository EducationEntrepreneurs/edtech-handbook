<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19f50f6f6fc6"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-05-15-06.php") )  ) ){
    ...
    <div class="wrapper_left">
        <div class="cat_sort">
            ...
            <div class="cat_sort_title">
                ...
                <?php $post_type = cat_sort_."<span class='post-type'></span>"; ?>
                <?php if($post_type=="cat_sort_<span class='post-type'>featured</span>"){
                    echo "featured";   
                }
                elseif($post_type=="cat_sort_<span class='post-type'>recent</span>"){
                    echo "recent";   
                }else{
                    echo "<script>alert(jQuery('.cat_sort select').val());</script>";
                    echo $post_type;
                }
                ?>
            </div>
             <?php if($_GET['page']!=""){ ?>
                        <body onload="cat_sort('<?php echo $category_name; ?>','<?php echo $paged; ?>');"></body>
            <?php } ?>
            <div class="sort">
