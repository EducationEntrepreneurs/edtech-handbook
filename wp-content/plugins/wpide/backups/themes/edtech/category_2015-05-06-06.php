<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f191838ca834f"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-05-06-06.php") )  ) ){
        ...
        ?>   
            <?php  while ( have_posts() ) : the_post(); ?>
                ...
                <div class="cat_posts">
                    ...
                    <div class="post_title"><a href="<?php the_permalink(); ?>" target="_blank"><h3><?php the_title(); ?></h3></a></div>
                ...
                <?php if($counter%2 == 0){
                    ?><div class="clearfix visible-xs-block visible-sm-block visible-md-block"></div><?php
                }?>
            <?php endwhile; ?>
        </div>
