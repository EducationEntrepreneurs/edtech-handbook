<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f193d94a8d34e"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-06-12-11.php") )  ) ){
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            jQuery('.search').autosuggest(se_ajax_url + '?action=se_lookup', {
                onSelect: function(e) {
                    //alert(jQuery(".ac_results li a:first").click());
                    //jQuery(this).focus();
                    //window.location.href = 
                    alert(jQuery(".ac_results li a:active").attr("href"));
                }
            });
        });
