<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f191838ca834f"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-05-06-10.php") )  ) ){
...
?>
    ...
    <div class="wrapper_left">
        ...
        <?php 
                ...
                echo $total_pages;
                /*if($total_posts%2==0){
                    $total_pages = ceil($total_posts/$subsequent_pages_post_count);
                }
                else{
                    $total_pages = ceil($total_posts/$subsequent_pages_post_count)+1;   
                }*/
                query_posts($args);
        ...
        ?>   
            <?php  while ( have_posts() ) : the_post(); ?>
                ...
                <div class="cat_posts">
                    ...
                    <div class="author_info">
                        <div style="float:left">
                                <div class="author_dp">
                                    <a href="../../expert?id=<?php echo get_the_author_meta( 'ID' ); ?>" target="_blank"><?php echo get_avatar( get_the_author_meta( 'ID' ), 32 ); ?></a>
                                </div>
                                <div class="author">
                                    <a href="../../expert?id=<?php echo get_the_author_meta( 'ID' ); ?>" target="_blank"><?php echo get_the_author(); ?></a>
                                </div>
                        </div>
                    ...
                    <div class="post_data">
                        <div class="post_image">
                            <?php   if ( has_post_thumbnail() ){
                                        ...
                                        ?><a href="<?php the_permalink(); ?>" target="_blank"><img src="<?php echo $post_img[0]; ?>" /></a><?php
                                    }
                                    else{
                ...
                <?php if($counter%2 == 0){
                    ?><div class="clearfix visible-xs-block visible-sm-block visible-md-block visible-lg-block"></div><?php
                }?>
            <?php endwhile; ?>
        </div>
