<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19f50f6f6fc6"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-05-15-06.php") )  ) ){
...
function all_posts($postid_array,$posttype,$page,$category_name,$select){
        ...
        while ( have_posts() ) : the_post();
            ...
            if(strlen(get_the_title())>=60){
                ...
                if($postid_array[0] != $post_id && $postid_array[1] != $post_id ){
           ...
           return $posttype.'<div class="hr-divider"><hr width="100%" /></div>'.$all_posts_start.$post_matter.$all_posts_end;
}           
