<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "97555ad40172e2ae2acf6e24b6801088695500ee86"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/team.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/team_2015-04-08-06.php") )  ) ){
...
get_header();?>
    <div id="experts-content">
		...
		?>
		<div class="expert_logo"><i class="fa fa-graduation-cap fa-5x"></i></div><div class="expert_title"><?php the_title(); ?></div>
		<?php
                 ?><div style="width:100%;"><?php  the_content(); ?></div><?php
			endwhile;
		?>
		<?php
            $args = array(
        ...
        ?>
                ...
                <div style="width:100%;"><img src="<?php echo $profile_image; ?>" class="expert_dp"/>
