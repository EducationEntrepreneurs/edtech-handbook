<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b5b36394a2b09f8ef6155ad17086bee7c6560371f1"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-04-09-09.php") )  ) ){
...
function custom_post_type() {
	...
	$args = array(
		...
		'description'         => __( 'Expert', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( ),
...
function rewrite_rule() {
  add_rewrite_rule('^leaf/([0-9]+)/?', 'index.php/user?id=$matches[1]', 'top');
}
