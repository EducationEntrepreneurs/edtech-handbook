<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19f999607a35"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-04-11-15.php") )  ) ){
        ...
        <div class="sort">
            <?php while ( have_posts() ) : the_post(); ?>
                <?php 
                    ...
                    $unix_post_time_ago=floor(abs($time-$unix_post_time)/60/60);
                    echo $unix_post_time_ago.' mins ago';
