<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19e47c853b3c"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/user.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/user_2015-04-29-08.php") )  ) ){
            ...
            <div class="user_profile">
                ...
                <div class="user_info">
                    ...
                    <div class="user_social">
                        <span><?php if($blog != ""){ ?><a href="<?php echo $blog; ?>" target="_BLANK"><i class="fa fa-globe"></i></a> <?php } ?></span>
                        <span><?php if($linkedin != ""){ ?><a href="<?php echo $linkedin; ?>" target="_BLANK"><i class="fa fa-linkedin-square"></i></a> <?php } ?></span>
                        <span><?php if($twitter != ""){ ?><a href="<?php echo $twitter; ?>" target="_BLANK"><i class="fa fa-twitter"></i></a> <?php } ?></span>
                    </div>
                </div>
            </div>
