<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f1906b34389e9"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-04-23-10.php") )  ) ){
...
function cat_sort_recent($catname){
    ...
    while ( have_posts() ) : the_post();
             $posttt=       $author_id = $post->post_author;
                    ...
                    $img = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ) ,"medium" );
                     '<div class="sorted_res"><div class="post_image"><img src="'.$img[0].'" width="100%" height="231px" /></div>
                            ...
                            <div class="post_content"><a href="'.the_permalink().'">'.the_excerpt().'</a></div>
                        </div>';
    endwhile;
   return $posttt;
}
