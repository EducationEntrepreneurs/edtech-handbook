<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19f999607a35"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-04-11-10.php") )  ) ){
...
?>
    ...
    <div class="wrapper_left">
        ...
        <div style="width:100%;float:left"><hr width="100%" /></div>
        <div class="all_post">
        <?php 
                $posts_per_page = 4;
                $paged=$_GET['page'];
