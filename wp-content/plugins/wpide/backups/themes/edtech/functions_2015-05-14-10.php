<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19e88604f605"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-05-14-10.php") )  ) ){
...
function all_posts($postid_array,$posttype,$page){
...
function cat_sort_featured($catname,$page){
    ...
    endwhile;
    wp_reset_query();
    $posts=all_posts($variable_post_ID,$post_featured,$page);
    return $posts;
}
