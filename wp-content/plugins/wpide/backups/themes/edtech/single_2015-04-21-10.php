<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f1912ab12aead"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/single_2015-04-21-10.php") )  ) ){
        ...
        <div class="post-content">
            ...
            <div class="vote">
                ...
                <div class="vote_answer"> 
                    <input type="button" name="Yes" Value="Yes" onclick="votecount(<?php echo $post_id; ?>,'<?php echo $ip; ?>')">
                    <input type="button" name="No" Value="No">
                </div>
            </div>
            <input type="button" value="click" onclick="showMacAddress()">
    <?php endwhile; ?>
            <div class="further">
