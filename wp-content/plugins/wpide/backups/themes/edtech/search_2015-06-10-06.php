<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19a42ad1fc83"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/search.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/search_2015-06-10-06.php") )  ) ){
...
<?php
    ...
    if($flag>0){ ?>
        ...
        <?php
            ...
            $pagerContainer = '<div class="pagination"><span class="page-numbers current">'.$page.'</span>';   
            if( $totalPages != 0 ) 
            {
              if( $page == 1 ) 
              { 
