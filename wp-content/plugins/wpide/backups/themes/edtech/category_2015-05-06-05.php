<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f191838ca834f"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-05-06-05.php") )  ) ){
    ...
    <div class="wrapper_left">
        ...
        ?>   
            <?php  while ( have_posts() ) : the_post(); ?>
                <?php   
                        $post_time='added '.time_elapsed(get_the_ID());
                        $counter++;
                ?>
                <div class="cat_posts">
                    ...
                    <div class="author_info">
                        ...
                        <div style="float:right;color:#ccc">
                            <i class="fa fa-thumbs-up"></i><span>Useful:<?php echo intval(get_post_meta(get_the_ID(),'vote_count_yes',true));?> votes</span>
                        </div>
                    </div>
                    <div class="post_data">
