<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "97555ad40172e2ae2acf6e24b6801088501bec4cb3"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/user.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/user_2015-04-08-14.php") )  ) ){
    ...
    <div class="user_container">
        <div class="wrapper_left">
            ...
            <div class="user_resources">
                <?php    query_posts('author='.$user_id); ?>
                        
                <?php            
                        if(have_posts()) :?><h3>Edtech Handbook resources by <?php echo $user->first_name; ?></h3><ul><?php while(have_posts()) : the_post(); 
