<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "97555ad40172e2ae2acf6e24b6801088f5f7ec64b5"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/team.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/team_2015-04-09-10.php") )  ) ){
...
get_header();?>
    <div id="experts-content">
        ...
        ?>
                ...
                <div style="width:100%;"><a href="../expert?id=<?php echo $user_id; ?>"><img src="<?php echo $profile_image; ?>" class="expert_dp"/></a>
