<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19616e6262f5"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-04-13-06.php") )  ) ){
...
?>
    ...
    <div class="wrapper_left">
        ...
        <div class="sort">
            <?php while ( have_posts() ) : the_post(); ?>
                <?php 
                    ...
                    $post_time=post_time(get_the_ID());
        ...
        <?php 
            ...
            ?>   
            <?php  while ( have_posts() ) : the_post(); ?>
                <?php $post_time=post_time(get_the_ID()); ?>
                <div class="cat_posts">
                    <div class="post_time"><?php echo $post_time; ?></div>
                    <div class="post_title"><h3><?php the_title(); ?></h3></div>
                    <div class="author_info">
