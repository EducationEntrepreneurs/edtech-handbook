<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b5b36394a2b09f8ef6155ad17086bee7c6560371f1"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/team.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/team_2015-04-09-09.php") )  ) ){
...
get_header();?>
    <div id="experts-content">
        ...
        ?>
                ...
                <div style="width:100%;"><a href="../user?id=<?php echo $user_id; ?>"><img src="<?php echo $profile_image; ?>" class="expert_dp"/></a>
