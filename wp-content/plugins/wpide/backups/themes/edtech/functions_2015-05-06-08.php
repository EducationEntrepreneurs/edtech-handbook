<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f191838ca834f"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-05-06-08.php") )  ) ){
...
function format($img,$current_position,$post_time){
    ...
    return  '<div class="sorted_res">'.$imagepath.'
                            ...
                            <div class="post_title"><a href="'.get_post_permalink().'" target="_blank"><h3>'.get_the_title().'</h3></a></div>
