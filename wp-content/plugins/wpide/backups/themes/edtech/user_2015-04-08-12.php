<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "97555ad40172e2ae2acf6e24b6801088501bec4cb3"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/user.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/user_2015-04-08-12.php") )  ) ){
    ...
    <div class="user_container">
        ...
        <div class="wrapper_right">
            <div class="user_social">
                <h3>More about <?php echo $first_name; ?></h3>
                <ul>
                    <li>Blog</li>
                    <li>LinkedIn</li>
                    <li>Twitter</li>
