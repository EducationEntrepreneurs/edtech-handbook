<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19465bd81e95"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/team.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/team_2015-04-24-12.php") )  ) ){
...
get_header();?>
    <div id="experts-content">
        ...
        ?>
                ...
                <div style="width:100%;"><a href="../expert?id=<?php echo $user_id; ?>&name=<?php echo $user_name; ?>"><img src="<?php echo $profile_image; ?>" class="expert_dp"/></a>
