<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f195e51e12633"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-06-05-07.php") )  ) ){
...
function search_result($text,$s){
        ...
        /*foreach ($positions as $value) {
            $put="<span class='ac_match'>";
            $text = putinplace($text, $put, $value);
            $put="</span>";
            $value=$value+strlen($s);
            $text = putinplace($text, $put, $value);
            //echo $value ."<br />";
        }*/
