<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "34fd8828ed8a1f8bcdc8fbd371f548578d2269a0eb"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-03-16-13.php") )  ) ){
...
$blockdisplay = '<div style="text-align:center;"><div class="col-md-3"><i class="fa '.$icons.'" aria-hidden="true" style="font-size:30px;"></i><h3>'.$blocktitle.'</h3><div>'.$description.'</div></div></div>';
return $blockdisplay;
}
