<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "8e90b7f77a28aa29679f586f78763cab26ecc6a29b"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-03-24-20.php") )  ) ){
...
function jump_to_section($section_links,$post_id){
	...
	$link_array= get_post_custom_values('jump_to_section_link',$post_id);
	$flag = 0;

	foreach($link_array as $link => $value ){
		 if(!strcmp($section_links,$link)){
		     $flag=0;
		 }
		 else{
		     $flag=1;
