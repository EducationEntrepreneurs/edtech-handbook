<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "7d1597fd08e2f96ef8655e358c76cda3a59599b0a7"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/team.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/team_2015-04-03-00.php") )  ) ){
...
get_header();?>
    <div id="experts-content">
        ...
        ?>
                ...
                <img src="<?php echo $comapny_logo1; ?>"/>
                <img src="<?php echo $comapny_logo2; ?>"/>
                <img src="<?php echo $comapny_logo3; ?>"/>
                </div>
        <?php
            }
        ?>
