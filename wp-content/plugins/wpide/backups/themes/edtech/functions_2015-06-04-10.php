<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19b3c588c665"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-06-04-10.php") )  ) ){
...
jQuery('.search').suggest(se_ajax_url + '?action=se_lookup');/*, {
    onSelect: function() {
        ...
        jQuery('.search').val(thevalue[0]);
    }
});*/

});
jQuery(".ac_results li").click(function(){
alert("alert");
        //jQuery(".search").focus(); 
    });
