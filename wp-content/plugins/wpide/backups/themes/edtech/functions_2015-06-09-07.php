<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19f1e9d237e7"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-06-09-07.php") )  ) ){
...
function search_format($img,$current_position,$category_name){
    ...
    return  '<div class="sorted_res">'.$imagepath.'
                            <div class="'.$category_name.'"><h5 class="post_category">'.$category_name.'</h5>
                            <div class="post_title"><a href="'.get_post_permalink().'"><h3>'.$title.'</h3></a></div>
                            <div class="author_info">
                                <div class="author_dp">
                                     <a href="../../expert?id='.get_the_author_meta( 'ID' ).'">'.get_avatar( get_the_author_meta( 'ID' ), 45 )
