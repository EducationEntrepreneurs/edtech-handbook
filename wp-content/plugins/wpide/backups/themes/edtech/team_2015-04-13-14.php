<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19568045c45e"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/team.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/team_2015-04-13-14.php") )  ) ){
...
get_header();?>
    <div id="experts-content">
        ...
        ?>
                ...
                <div style="width:100%;"><a href="../expert0?id=<?php echo $user_id; ?>"><img src="<?php echo $profile_image; ?>" class="expert_dp"/></a>
