<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19e47c853b3c"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/user.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/user_2015-04-29-10.php") )  ) ){
        ...
        <div class="wrapper">
            ...
            <div class="user_experience">
                ...
                <?php if($company_logo1 != ""){
                    ?><div class="user_company"><span><img src="<?php echo $company_logo1; ?>" alt="<?php echo $company1; ?>" class="company_logo"/></span><?php echo $designation1; ?> @ <span><?php echo $company1; ?></span> : <?php echo $rolec1; ?></div>
                <?php }
                if($company_logo2 != ""){
                    ?><div class="user_company"><span><img src="<?php echo $company_logo2; ?>" alt="<?php echo $company2; ?>" class="company_logo"/></span><?php echo $designation2; ?> @ <span><?php echo $company2; ?></span> : <?php echo $rolec2; ?></div>
                <?php }
                if($company_logo3 != ""){    
                    ?><div class="user_company"><span><img src="<?php echo $company_logo3; ?>" alt="<?php echo $company3; ?>" class="company_logo"/></span><?php echo $designation3; ?> @ <span><?php echo $company3; ?></span> : <?php echo $rolec3; ?></div>
                <?php }  ?>
            </div>
