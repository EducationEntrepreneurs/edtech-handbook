<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19a6d1e18961"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-06-11-13.php") )  ) ){
       ...
       // $max = count($positions);
        ...
        foreach ($positions as $key => &$value) {
                ...
                //if($value>30 && $value>$j+30){
                    ...
                    //echo "newvalue".$val."<br/>";
                    echo "length".$length."<br/>";
                    $j=$value + 10;
                    $positions[$key]=$value - 20 + 2;
                    $key2=$key+1;
                    $next=$positions[$key2];
                    $next=$next-$length+2;
                    $positions[$key2]=$next;
