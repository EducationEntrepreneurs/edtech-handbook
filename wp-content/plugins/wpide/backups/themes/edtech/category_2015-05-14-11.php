<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19e88604f605"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-05-14-11.php") )  ) ){
...
?>
    ...
    <div class="wrapper_left">
        <div class="cat_sort">
            ...
            <?php } ?>
            <?php if($_GET['page']!=""){ ?>
                        <span onblur="cat_sort('<?php echo $category_name; ?>','<?php echo $paged; ?>');">hi</span>
            <?php } ?>
            </div>
    </div>
