<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19e88604f605"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-05-14-06.php") )  ) ){
...
function format_all($img,$current_position,$post_time){
...
function cat_sort_featured($catname){
    ...
    while ( have_posts() ) : the_post();
        ...
        if($post_type[0]=='featured' && $flag<2){
            ...
            $post_recent = $post_recent . format_all($img,$current_position,$post_time);
        }
    endwhile;
    wp_reset_query();
    return $post_featured.$post_recent;
}
