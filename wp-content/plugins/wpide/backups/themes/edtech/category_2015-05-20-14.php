<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f1901de0763db"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-05-20-14.php") )  ) ){
...
?>
    ...
    <div class="wrapper_left">
        <div class="cat_sort">
            ...
            <div class="btn-group">
                <button class="btn btn-default btn-md dropdown-toggle sort_button" type="button" data-toggle="dropdown" aria-expanded="false">
