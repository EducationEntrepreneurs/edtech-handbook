<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f192d64590745"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-06-17-07.php") )  ) ){
...
function format($img,$current_position,$post_time){
    ...
    return  '<div class="sorted_res">'.$imagepath.'
                            ...
                            <div class="author_info">
                                ...
                                .'</a></div>
                                <div class="author">                                
                                        <a href="../../expert?id='.get_the_author_meta( 'ID' ).'"><p>'.get_the_author().'</p></a>
