<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "34fd8828ed8a1f8bcdc8fbd371f54857edff84acba"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-03-23-21.php") )  ) ){
...
function homeblock_func( $atts ) {
    ...
    $blockdisplay = '<div class="home-block"><a href="#"><i class="fa '.$icons.'"></i><h3>'.$blocktitle.'</h3><div>'.$description.'</div></a></div>';
    return $blockdisplay;
}
