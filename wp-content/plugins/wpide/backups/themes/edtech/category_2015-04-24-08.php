<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f199cc3fca3d9"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-04-24-08.php") )  ) ){
            ...
            <?php $authorID=edtech_author($category_name); 
                  foreach($authorID as $author){
                     ...
                     ?><div class="author_info">
                            ...
                            <div class="author">                                
                                <a href="../../expert?id=<?php echo $author; ?>"><p><?php echo $author_name; ?></p></a>
