<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f1974b699a825"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/search.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/search_2015-06-10-13.php") )  ) ){
        ...
        <?php
            ...
            if( $totalPages != 0 ) 
            {
                ...
                { 
                    ...
                    $counter=1;
                    for($j=1;$j<$page;$j++){
                        if(($counter==1 || $counter==2)  || ($counter > ($page-3)) ){
                            if($j==1){
