<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b5b36394a2b09f8ef6155ad17086bee717225fd540"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/user.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/user_2015-04-08-19.php") )  ) ){
        ...
        <div class="wrapper_left">
            ...
            <div class="user_resources">
                <?php   $category =array(6,7);
                        ...
                        query_posts(array('author'=>$user_id,'category__in' => array(6,7),'posts_per_page' => 3));
                        
                        if(have_posts()) :?><h3>Edtech Handbook resourcinby <?php echo $user->first_name; ?></h3><?php while(have_posts()) : the_post(); 
                        ?>
                        <p> <?php if(is_category('6')): ?><i class="fa fa-lightbulb-o"></i><?php endif; ?>
                            <?php if(is_category('7')): ?><i class="fa fa-comment"></i><?php endif; ?>
                            <?php if(is_category('Build')){ ?><i class="fa fa-user"></i><?php } ?>
                            <?php if(is_category('Grow')){ ?><i class="fa fa-leaf"></i><?php } ?>
