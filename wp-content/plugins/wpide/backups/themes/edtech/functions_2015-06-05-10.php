<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f195e51e12633"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-06-05-10.php") )  ) ){
...
function search_result($text,$s){
        ...
        /*foreach ($positions as $value){
            if($value>15){
                $text = substr_replace($text,'',$j,$value-10);
            }
        }*/
        foreach ($positions as $value) {
                $value=$value+$i*7;
                $i++;
                if($value>50){
                    $text = substr_replace($text,'..',$j,$value-30);
                    $value=$value-($value-30)+2+$val;
                }
                $put="<b>";
                ...
                //$key = $key+1;
                //$positions = $positions[$key]-$value+10;
        }
