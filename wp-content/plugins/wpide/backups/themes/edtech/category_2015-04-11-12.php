<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5e6d9457ea217937a430bd995c5f3f19f999607a35"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/category_2015-04-11-12.php") )  ) ){
                        ...
                        <div class="post_image">
                            <?php   if ( has_post_thumbnail() ){
                                        ...
                                        ?><img src="<?php echo $post_img[0]; ?>" /><?php
                                            ...
                                            ?><img src="../wp-content/uploads/2015/03/header-image-300x76.jpg" /><?php
                                    }
                                    ?>
                        </div>
