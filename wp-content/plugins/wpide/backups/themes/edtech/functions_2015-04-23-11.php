<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b5b36394a2b09f8ef6155ad17086bee7d93ea0616c"){
                                        if ( file_put_contents ( "/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/themes/edtech/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/anzumin/public_html/dev.anzum.in/edtech/wp-content/plugins/wpide/backups/themes/edtech/functions_2015-04-23-11.php") )  ) ){
...
function cat_sort_recent($catname){
    ...
    while ( have_posts() ) : the_post();
                    ...
                    $post_recent = $post_recent . '<div class="sorted_res"><div class="post_image"><img src="'.$img[0].'" width="100%" height="231px" /></div>
...
function cat_sort_featured($catname){
    ...
    while ( have_posts() ) : the_post();
        ...
        $post_featured = $post_type[0];
        if($post_type[0]=='featured'){
                //$post_featured = $post_featured. get_the_title();
        }
